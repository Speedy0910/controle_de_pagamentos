...
class CadastroMaternalI extends StatefulWidget {
  const CadastroMaternalI({super.key});

  @override
  State<CadastroMaternalI> createState() => _HomePageState();
}

class _HomePageState extends State<CadastroMaternalI> {
  @override
    ...
    return Scaffold(
      drawer: Drawer(
          child: Container(
            ...
            child: Column(
              children: [
                ...
                MyWidgets().checkPayMTI(context: context)
              ],
            ),
          )
        ),
        appBar: AppBar(
          title: MyWidgets().textAppBar(texto: 'Cadastros do Maternal I'),
        ...
        body: Container(
            ...
            child: FutureBuilder(
                future: GetterDatabase().getMaternalI(),
