...
class CadastroJardimI extends StatefulWidget {
  const CadastroJardimI({super.key});

  @override
  State<CadastroJardimI> createState() => _HomePageState();
}

class _HomePageState extends State<CadastroJardimI> {
  @override
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                MyWidgets().checkPayJDI(context: context)
              ],
            ),
          )
        ),
        appBar: AppBar(
          title: MyWidgets().textAppBar(texto: 'Cadastros do Jardim I'),
