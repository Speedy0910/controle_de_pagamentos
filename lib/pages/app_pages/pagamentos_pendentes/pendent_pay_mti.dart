...
class PagamentosPendentesMTI
 extends StatefulWidget {
  const PagamentosPendentesMTI
  ({super.key});

  @override
  State<PagamentosPendentesMTI
  > createState() => _HomePageState();
}

class _HomePageState extends State<PagamentosPendentesMTI
> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: MyWidgets().textAppBar(texto: 'Pendências do MTI'),
