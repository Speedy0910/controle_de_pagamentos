...
class PagamentosPendentesJDII
 extends StatefulWidget {
  const PagamentosPendentesJDII
  ({super.key});

  @override
  State<PagamentosPendentesJDII
  > createState() => _HomePageState();
}

class _HomePageState extends State<PagamentosPendentesJDII
> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: MyWidgets().textAppBar(texto: 'Pendências do JDII'),
