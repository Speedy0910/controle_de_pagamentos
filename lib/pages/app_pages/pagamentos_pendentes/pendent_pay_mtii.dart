...
class PagamentosPendentesMTII extends StatefulWidget {
  const PagamentosPendentesMTII({super.key});

  @override
  State<PagamentosPendentesMTII> createState() => _HomePageState();
}

class _HomePageState extends State<PagamentosPendentesMTII> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: MyWidgets().textAppBar(texto: 'Pendências do MTII'),
